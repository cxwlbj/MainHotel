...
//static const CGFloat kHeightOfTopScrollView = 54.0f;
...
//控制器的View的视图高度需要减去此高度
#define kHeightOfTopScrollView 54.0f
#define KButtonHeight 33.0f
#define KButtonWidth 66.0f
#define kWidthOfButtonMargin ([[UIScreen mainScreen] bounds].size.width - KButtonWidth * [_viewArray count]) / ([_viewArray count] + 1)
...
//                                   lineBreakMode:NSLineBreakByTruncatingTail];
        ...
        //自定义
        CGSize textSize = (CGSize){KButtonWidth, KButtonHeight};
        
        //累计每个tab文字的长度
        topScrollViewContentWidth += kWidthOfButtonMargin+textSize.width;
        //设置按钮尺寸
        [button setFrame:CGRectMake(xOffset,0,
                                    textSize.width, textSize.height)];//之前高度等于topviewHeight
        ...
        [button setImage:[UIImage imageNamed:self.titleImages[i]] forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:self.titleSelectImages[i]] forState:UIControlStateSelected];
        button.imageView.contentMode = UIViewContentModeScaleAspectFit;
        //button.titleEdgeInsets = UIEdgeInsetsMake(0, button.imageView.width, 0, button.imageView.bottom);
        button.titleLabel.textAlignment = NSTextAlignmentCenter;
        button.titleEdgeInsets = UIEdgeInsetsMake(0, -90, -60, 0);
