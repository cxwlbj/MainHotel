...
- (void)setUpSubviews{
    ...
    CGFloat baseWidth = self.width;
    CGFloat baseHeight = self.height;
    ...
    CGFloat showImageW = baseWidth * .75;
    CGFloat showImageH = baseHeight * .75;
    ...
    CGFloat hotelNameY = _showImage.bottom - XCellMargin * 2;
