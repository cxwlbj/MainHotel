...
- (void)contentViewTapAction:(UITapGestureRecognizer *)tap
{
    ...
    //2.使用代理
    if ([self.delegate respondsToSelector:@selector(autoSlideScrollViewDidSelectPageNum:pageIndex:)]) {
        [self.delegate autoSlideScrollViewDidSelectPageNum:self pageIndex:self.currentPageIndex];
    }
}
